...
function vitePluginCopyStaticScripts(): Plugin {
  return {
    name: "copy-static-vanilla-scripts",
    closeBundle() {
      const source = path.resolve(import.meta.dirname, "client", "js", "main.js");
      const destinationDir = path.resolve(import.meta.dirname, "dist", "public", "js");
      fs.mkdirSync(destinationDir, { recursive: true });
      fs.copyFileSync(source, path.join(destinationDir, "main.js"));
    },
  };
}
  ...
  build: {
    ...
    rollupOptions: {
      input: {
        ...
        experience: path.resolve(import.meta.dirname, "client/experience.html"),
